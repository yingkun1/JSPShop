        ...
        <div class="orderL fl"><!--------h3----------------><h3>收件信息<a href="#" class="fr">新增地址</a></h3>
            ...
            <div class="addres clearfix">
                <div class="addre fl on">
                    <div class="tit clearfix"><p class="fl">${sessionScope.user.USER_NAME} <span class="default">[默认地址]</span></p>
                        <p class="fr"><a href="#">删除</a><span>|</span><a href="#" class="edit">编辑</a></p></div>
                    <div class="addCon"><p>${sessionScope.user.USER_ADDRESS}</p>
                        <p>${sessionScope.user.USER_MOBILE}</p></div>
                </div>
        ...
        <div class="orderR fr">
            <div class="msg"><h3>订单内容<a href="cart.html" class="fr">返回购物车</a></h3><!--------ul---------------->
                <c:forEach items="${requestScope.shoplist}" var="shop">
                    <ul class="clearfix">
                        <li class="fl"><img style="width: 120px;height: 120px" src="img/product/${shop.CART_P_FILENAME}"></li>
                        <li class="fl"><p>${shop.CART_P_NAME}</p>
                            <p>图书分类：</p>
                            <p>数量：${shop.CART_P_NUMBER}</p></li>
                        <li class="fr">￥${shop.CART_P_PRICE * shop.CART_P_NUMBER}</li>
                    </ul>
                </c:forEach>


            </div><!--------tips---------------->
            <div class="tips"><p><span class="fl">商品金额：</span><span class="fr">￥${requestScope.sumPrice}.00</span></p>
                <p><span class="fl">优惠金额：</span><span class="fr">￥0.00</span></p>
                <p><span class="fl">运费：</span><span class="fr">免运费</span></p></div><!--------tips count---------------->
            <div class="count tips"><p><span class="fl">合计：</span><span class="fr">￥${requestScope.sumPrice}.00</span></p></div>
