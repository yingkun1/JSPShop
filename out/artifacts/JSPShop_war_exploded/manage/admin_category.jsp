...
<div class="main-wrap">
    ...
    <div class="search-wrap">
        <div class="search-content">
            <form action="admin_categoryselect" method="get">
...
<%--                    </c:forEach>--%>
                ...
                <div class="list-page">
                    ...
                    <a href="admin_categoryselect?${requestScope.keywords}">首页</a>
                    <a href="admin_categoryselect?count=${requestScope.count}&currentPage=${requestScope.currentPage-1 ==0 ? 1 :requestScope.currentPage-1}${requestScope.keywords}">上一页</a>
                    <a href="admin_categoryselect?count=${requestScope.count}&currentPage=${requestScope.currentPage+1 >requestScope.totalPagesNums ? requestScope.totalPagesNums:requestScope.currentPage+1}${requestScope.keywords}">下一页</a>
                    <a href="admin_categoryselect?count=${requestScope.count}&currentPage=${requestScope.totalPagesNums}${requestScope.keywords}">尾页</a>
                </div>
            </div>
        </form>
    </div>
